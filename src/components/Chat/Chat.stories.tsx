...
export const SlashCommands = story(examples.slashCommands)
export const SlashCommandsDark = story(examples.slashCommands, 'dark')
export const Dictation = story(examples.dictation)
